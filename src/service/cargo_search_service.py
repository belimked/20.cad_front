...
class CargoSearchService(BaseGenerationService):
    """
    ...
    def generate_search_cargo_data(self, business_object: str = BUSINESS_OBJECT,
        ...
        Args:
            business_object: 业务对象名称，默认为searchCargo
...
def get_search_cargo_service():
    return CargoSearchService.get_instance()
...
def generate_search_cargo_data(business_object: str = CargoSearchService.BUSINESS_OBJECT,
    ...
    search_cargo_service = get_search_cargo_service()

    # 调用生成方法，传递变种服务实例
    return search_cargo_service.generate_search_cargo_data(
        business_object,
        total_samples,
        variations_per_rule,
...
if __name__ == "__main__":
    try:
        ...
        staffing_data = generate_search_cargo_data(total_samples=10, variations_per_rule=2)
